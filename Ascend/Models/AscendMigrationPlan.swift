...
enum AscendMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [AscendSchemaV6.self, AscendSchemaV8.self, AscendSchemaV9.self, AscendSchemaV10.self, AscendSchemaV11.self]
    }
    ...
    static var stages: [MigrationStage] {
        [
            ...
            .lightweight(fromVersion: AscendSchemaV10.self, toVersion: AscendSchemaV11.self)
        ]
    }
}
