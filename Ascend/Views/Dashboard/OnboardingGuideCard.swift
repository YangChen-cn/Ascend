        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                guideStep(
                    ...
                    action: { appState.openSettings(section: .sources) }
                )
                ...
                guideStep(
                    ...
                    action: { appState.openSettings(section: .ai) }
                )
                ...
                guideStep(
                    ...
                    action: { Task { await appState.runAnalysis() } }
                )
            }
        }
    }

    private func guideStep(num: String, title: String, desc: String, isDone: Bool, action: @escaping () -> Void) -> some View {
